                            ...
                            <>
                               <GridItem colSpan={{ base: 12, md: 6 }}>
                                    <FormLabel display="flex" fontSize="sm" fontWeight="500" mb="8px">
                                        Assignment To Contact<Text color="red">*</Text>
                                    </FormLabel>
                                    <Flex justifyContent="space-between">
                                        <Select
                                            ...
                                            name="assignmentTo"
                                            onChange={(e) => {
                                                const selectedContact = assignmentToData.find((contact) => contact._id === e.target.value);
                                                setFieldValue('assignmentTo', selectedContact?._id || '');
                                                setFieldValue(
                                                    'studentName',
                                        ...
                                        >
                                            {assignmentToData?.map((contact) => (
                                                <option value={contact._id} key={contact._id}>
                                    ...
                                    <Text mb="10px" color="red">
                                        {errors.assignmentTo && touched.assignmentTo && errors.assignmentTo}
                                    </Text>
                                </GridItem>
