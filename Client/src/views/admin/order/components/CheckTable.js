      ...
      >
        ...
        <Flex px="25px" justify="space-between" mb="20px" align="center">
          <Text
            ...
            lineHeight="100%"
          >
            Orders (<CountUpComponent targetNumber={data?.length} />)
          </Text>
          {setTaskModel && <Button onClick={() => setTaskModel(true)} leftIcon={<AddIcon />} colorScheme="gray" >Create Order</Button>}
        </Flex>
                  ...
                  return (
                    <Tr {...row?.getRowProps()} key={i}>
                      {row?.cells?.map((cell, index) => {
                        ...
                        } else if (cell?.column.Header === "Student Program ID") {
                          data = (
                            <Text
                              me="10px"
                              color={textColor}
                        ...
                        else if (cell?.column.Header === "Ordered Date") {
                            data = (
                              <Text
                                me="10px"
                                color={textColor}
