import {
  ...
  export default function CheckTable(props) {
    const { columnsData, fetchData, data, isLoding, setCaseModel, className } = props;
      ...
      >
        ...
        <Flex px="25px" justify="space-between" mb="20px" align="center">
          <Text
            ...
            lineHeight="100%"
          >
            Cases (<CountUpComponent targetNumber={data?.length} />)
          </Text>
          {setCaseModel && <Button onClick={() => setCaseModel(true)} leftIcon={<AddIcon />} colorScheme="gray" >Create Case</Button>}
        </Flex>
